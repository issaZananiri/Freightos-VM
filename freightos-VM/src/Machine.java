...
public class Machine {
	...
	public static void main(String[] args) {
        ...
        snackVendingMachine.loadItems("Maltesers", 4.0, 15);
        snackVendingMachine.loadItems("Starbust", 1.5, 5);
        snackVendingMachine.loadItems("Mars", 2.15, 12);
    ...
    public void runMachine() {
        ...
        System.out.println("Please enter coins and bills followed by enter to start selection: ");
        boolean exit = false;
        while (true)
        {
        	while (input.hasNext()) {
        		...
        		else if (input.next().equals("enter"))
        			break;
        	}
            while (!exit) {
            	...
            	if(input.hasNextInt()) {
                    ...
                    if (command.equals("$")) {
                        ...
                        System.out.println("Please enter coins and bills followed by enter to add credit");
                        while (input.hasNext()) {
                            if (input.hasNextDouble())
                            this.userMoney = this.userMoney + input.nextDouble();
                            else if (input.next().equals("enter"))
